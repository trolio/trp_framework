...
function user.isInVehicle(vehicle, atGetiIn)
    return IsPedInVehicle(PlayerPedId(), vehicle, atGetiIn)
end
...
function user.setPedIntoVehicle(vehicle, setIndex)
